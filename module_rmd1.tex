...
Here is a word in \textbf{bold}

Here is a word in \emph{italic}

We use \texttt{rmarkdown} package
...
\includegraphics{module_rmd1_files/figure-latex/pressure-1.pdf}

Note that the \texttt{echo\ =\ FALSE} parameter was added to the code
chunk to prevent printing of the R code that generated the plot.

\includegraphics{module_rmd1_files/figure-latex/pressure2-1.pdf}
...
\begin{longtable}[]{@{}rr@{}}
\caption{Top 6 rows of \texttt{cars} dataset}\tabularnewline
\toprule
...
\hypertarget{inset-an-equation}{%
\subsection{Inset an equation}\label{inset-an-equation}}

\[ Y = \beta_0 + \beta_1x \] \#\# Insert Images
